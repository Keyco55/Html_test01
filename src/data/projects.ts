...
export const FEATURED_PROJECTS: readonly Project[] = [
  ...
  },
  {
    ...
    subtitle: '학과 홍보영상·웹툰 기획 제작 및 Python 웹 크롤링 실습',
    category: 'Growth & Automation',
    status: 'Internal Production Verified',
    summary:
      '학과 홍보영상과 교내 경진대회 영상 콘텐츠를 기획·제작하고 웹툰 10화를 발행했습니다. 실습 프로젝트에서는 Python(BeautifulSoup/Selenium)으로 웹 데이터를 수집했습니다. 2023 콘텐츠 기획·제작 경진대회 대상, 2021 최우수상을 수상했습니다.',
    metadata: {
    ...
    narrative: {
      ...
      technicalHighlights: [
        ...
        'Visual Storytelling & Webtoon Serialization',
