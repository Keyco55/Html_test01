...
export const DEVELOPER_TOOLS: readonly DeveloperToolItem[] = [
  {
    ...
    purpose:
      '단일 프로젝트의 대규모 작업을 Foundation, Platform, Projects, Resume 등 독립된 Git worktree로 분리하고, Human이 선택한 AI 에이전트와 수동 작업자를 cmux 세션에 배치하여 작업 컨텍스트 간 간섭을 줄입니다.',
    keyFeatures: [
      'Git Worktree 기반 물리 디렉토리 격리 (메인 브랜치 오염 방지)',
      'cmux 세션을 통한 병렬 에이전트 작업 상태 및 출력 감시',
  ...
  },
  {
    ...
    keyFeatures: [
      'Apple Silicon 및 Intel Mac을 대상으로 한 네이티브 앱 구성',
      '경량 네이티브 구현으로 시스템 자원 점유율 극소화',
      '프라이버시 최우선: 토큰, 프롬프트, 쿠키 비접근 원칙',
      '동적 2줄 상태 말풍선 및 세션 자동 포커싱 AppleScript/AppKit 브리지',
    ],
    techStack: ['Swift', 'macOS AppKit', 'SwiftUI', 'AppleScript', 'CoreAnimation'],
  },
  {
    ...
    keyFeatures: [
      ...
      'Human이 모델을 선택할 수 있도록 Multi-Agent 리소스 잔여량 판단 데이터 제공',
    ],
